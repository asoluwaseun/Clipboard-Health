                ...
                >
                    <div className="flex flex-1 flex-col p-1">
                        <div className="flex flex-col lg:flex-row mb-2">
                            <span className="font-bold w-7/12">Department:</span>
                            <p className="w-5/12">
                                {job_description.department.join().replaceAll(",", ", ")}
                            </p>
                        </div>
                        <div className="flex flex-col lg:flex-row mb-2">
                            <span className="font-bold w-7/12">Hours / shift:</span>
                            <p className="w-5/12">{`${job_description.hours[0]} hours / shift`}</p>
                        </div>
                    </div>
                    <div className="flex lg:w-48 lg:flex-col lg:items-end">
                        <button
                            className=" bg-blue-500 text-white rounded-md px-5 py-3 m-1"
                        >
                            Job details
                        </button>
                        <button
                            className="border border-blue-500 text-blue-500 rounded-md px-5 py-3 m-1"
                        >
                            Save job
                        </button>
                    </div>
